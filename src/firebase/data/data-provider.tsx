...
const sectionsData = [
  { name: 'D 40 [Door]', ratePerKg: 1010, weightPerFt: 0.49, ratePerFt: 495 },
  { name: 'D 40 C [Door]', ratePerKg: 1010, weightPerFt: 0.16, ratePerFt: 162 },
  { name: 'SP 40 [Door]', ratePerKg: 1010, weightPerFt: 0.44, ratePerFt: 444 },
  { name: 'SP 2.5*1 [Door]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'SP 2.5*1 G [Door]', ratePerKg: 1010, weightPerFt: 0.22, ratePerFt: 222 },
  { name: 'SP 3*1 [Door]', ratePerKg: 1010, weightPerFt: 0.36, ratePerFt: 364 },
  { name: 'SP 3*1 G [Door]', ratePerKg: 1010, weightPerFt: 0.26, ratePerFt: 263 },
  { name: 'SP 3*1.5 [Door]', ratePerKg: 1010, weightPerFt: 0.5, ratePerFt: 505 },
  { name: 'SP 4*1 [Door]', ratePerKg: 1010, weightPerFt: 0.45, ratePerFt: 455 },
  { name: 'SP 4*1.5 [Door]', ratePerKg: 1010, weightPerFt: 0.65, ratePerFt: 657 },
  { name: 'SP 4*2 [Door]', ratePerKg: 1010, weightPerFt: 0.85, ratePerFt: 859 },
  { name: 'D 25 [Door]', ratePerKg: 1010, weightPerFt: 0.35, ratePerFt: 354 },
  { name: 'D 25 C [Door]', ratePerKg: 1010, weightPerFt: 0.13, ratePerFt: 131 },
  { name: 'D 25 F [Door]', ratePerKg: 1010, weightPerFt: 0.21, ratePerFt: 212 },
  { name: 'D 25 F Gola [Door]', ratePerKg: 1010, weightPerFt: 0.08, ratePerFt: 81 },
  { name: 'D 25 G [Door]', ratePerKg: 1010, weightPerFt: 0.23, ratePerFt: 232 },
  { name: 'D 25 G Gola [Door]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'D 25 K [Door]', ratePerKg: 1010, weightPerFt: 0.28, ratePerFt: 283 },
  { name: 'D 25 KG [Door]', ratePerKg: 1010, weightPerFt: 0.19, ratePerFt: 192 },
  { name: 'F 25 [Door]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'F 25 C [Door]', ratePerKg: 1010, weightPerFt: 0.11, ratePerFt: 111 },
  { name: 'F 25 G [Door]', ratePerKg: 1010, weightPerFt: 0.21, ratePerFt: 212 },
  { name: 'F 25 T [Door]', ratePerKg: 1010, weightPerFt: 0.21, ratePerFt: 212 },
  { name: 'F 25 P [Door]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'IN 25 [Door]', ratePerKg: 1010, weightPerFt: 0.29, ratePerFt: 293 },
  { name: 'IN 25 C [Door]', ratePerKg: 1010, weightPerFt: 0.11, ratePerFt: 111 },
  { name: 'IN 25 G [Door]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: 'IN 25 P [Door]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'D 38 [Door]', ratePerKg: 1010, weightPerFt: 0.44, ratePerFt: 444 },
  { name: 'D 38 C [Door]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'D 38 F [Door]', ratePerKg: 1010, weightPerFt: 0.26, ratePerFt: 263 },
  { name: 'D 38 FG [Door]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: 'D 38 G [Door]', ratePerKg: 1010, weightPerFt: 0.26, ratePerFt: 263 },
  { name: 'D 38 GG [Door]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: 'F 38 [Door]', ratePerKg: 1010, weightPerFt: 0.44, ratePerFt: 444 },
  { name: 'F 38 C [Door]', ratePerKg: 1010, weightPerFt: 0.14, ratePerFt: 141 },
  { name: 'F 38 G [Door]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'IN 38 [Door]', ratePerKg: 1010, weightPerFt: 0.44, ratePerFt: 444 },
  { name: 'IN 38 C [Door]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'IN 38 G [Door]', ratePerKg: 1010, weightPerFt: 0.29, ratePerFt: 293 },
  { name: 'IN 38 P [Door]', ratePerKg: 1010, weightPerFt: 0.2, ratePerFt: 202 },
  { name: 'IN 38 T [Door]', ratePerKg: 1010, weightPerFt: 0.26, ratePerFt: 263 },
  { name: 'D 100 [Sliding]', ratePerKg: 1010, weightPerFt: 0.72, ratePerFt: 727 },
  { name: 'DD 100 [Sliding]', ratePerKg: 1010, weightPerFt: 0.9, ratePerFt: 909 },
  { name: 'F 100 [Sliding]', ratePerKg: 1010, weightPerFt: 0.72, ratePerFt: 727 },
  { name: 'FF 100 [Sliding]', ratePerKg: 1010, weightPerFt: 0.9, ratePerFt: 909 },
  { name: 'I 100 [Sliding]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'I 100 G [Sliding]', ratePerKg: 1010, weightPerFt: 0.4, ratePerFt: 404 },
  { name: 'D 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.65, ratePerFt: 657 },
  { name: 'DD 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.76, ratePerFt: 768 },
  { name: 'F 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.6, ratePerFt: 606 },
  { name: 'FF 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.72, ratePerFt: 727 },
  { name: 'I 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.28, ratePerFt: 283 },
  { name: 'I 75 G [Sliding]', ratePerKg: 1010, weightPerFt: 0.38, ratePerFt: 384 },
  { name: 'H 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.17, ratePerFt: 172 },
  { name: 'G 75 [Sliding]', ratePerKg: 1010, weightPerFt: 0.2, ratePerFt: 202 },
  { name: 'D 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.48, ratePerFt: 485 },
  { name: 'DD 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.58, ratePerFt: 586 },
  { name: 'F 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.45, ratePerFt: 455 },
  { name: 'FF 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.56, ratePerFt: 566 },
  { name: 'I 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.25, ratePerFt: 253 },
  { name: 'I 65 G [Sliding]', ratePerKg: 1010, weightPerFt: 0.34, ratePerFt: 343 },
  { name: 'H 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.16, ratePerFt: 162 },
  { name: 'G 65 [Sliding]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: 'D 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.22, ratePerFt: 222 },
  { name: 'DD 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'F 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.19, ratePerFt: 192 },
  { name: 'FF 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.28, ratePerFt: 283 },
  { name: 'I 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'H 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'G 27 [Sliding]', ratePerKg: 1010, weightPerFt: 0.12, ratePerFt: 121 },
  { name: 'D 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'DD 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.35, ratePerFt: 354 },
  { name: 'F 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.24, ratePerFt: 242 },
  { name: 'FF 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: 'I 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.16, ratePerFt: 162 },
  { name: 'H 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'G 32 [Sliding]', ratePerKg: 1010, weightPerFt: 0.12, ratePerFt: 121 },
  { name: '40*40 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: '32*32 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: '25*25 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: '19*19 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.08, ratePerFt: 81 },
  { name: '15*15 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.05, ratePerFt: 51 },
  { name: '12*12 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.04, ratePerFt: 40 },
  { name: '15*19 [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.07, ratePerFt: 71 },
  { name: 'L Patti [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.07, ratePerFt: 71 },
  { name: 'U Patti [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.07, ratePerFt: 71 },
  { name: 'Big U [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'T Patti [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.07, ratePerFt: 71 },
  { name: 'T Zali [Aluminium Angle]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: '3/4 Round Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.13, ratePerFt: 131 },
  { name: '1" Round Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: '1.25" Round Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.2, ratePerFt: 202 },
  { name: '1.5" Round Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.25, ratePerFt: 253 },
  { name: '2" Round Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.35, ratePerFt: 354 },
  { name: '1*1 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.2, ratePerFt: 202 },
  { name: '1.25*1.25 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.26, ratePerFt: 263 },
  { name: '1.5*1.5 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: '2*1 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.3, ratePerFt: 303 },
  { name: '3*1.5 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.45, ratePerFt: 455 },
  { name: '4*1.5 Square Pipe [Aluminium Pipe]', ratePerKg: 1010, weightPerFt: 0.6, ratePerFt: 606 },
  { name: 'Showcase Patti [Showcase]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'Showcase Pata [Showcase]', ratePerKg: 1010, weightPerFt: 0.15, ratePerFt: 152 },
  { name: 'Showcase Gola [Showcase]', ratePerKg: 1010, weightPerFt: 0.05, ratePerFt: 51 },
  { name: 'Showcase Corner [Showcase]', ratePerKg: 1010, weightPerFt: 0.08, ratePerFt: 81 },
  { name: 'Showcase Door [Showcase]', ratePerKg: 1010, weightPerFt: 0.1, ratePerFt: 101 },
  { name: 'Showcase Handle [Showcase]', ratePerKg: 1010, weightPerFt: 0.07, ratePerFt: 71 },
  { name: 'ADC Louver [Louver]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
  { name: 'ADC Louver Frame [Louver]', ratePerKg: 1010, weightPerFt: 0.18, ratePerFt: 182 },
];
