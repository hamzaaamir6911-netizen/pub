...
export default function PrintSimpleInvoicePage() {
  ...
  const uniformProps = (() => {
    ...
    const allSame = sale.items.every(
      item => item.thickness === firstItem.thickness && item.color === firstItem.color
    );
    if (allSame) {
      return {
                  ...
                  <div className="grid grid-cols-2 gap-x-4 mt-2 text-sm">
                      ...
                      {uniformProps && (
                        <>
                            ...
                            <span className="font-semibold">{uniformProps.thickness}</span>
                            <span className="font-bold">Color:</span>
                            <span className="font-semibold">{uniformProps.color}</span>
                        </>
                      )}
                  </div>
              </div>
