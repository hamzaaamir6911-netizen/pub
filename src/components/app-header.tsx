...
import { Factory, LayoutDashboard, Warehouse, ShoppingCart, Users, CreditCard, BarChart3, LogOut, BookUser, Settings, Truck, Menu, FileQuestion, HardHat, NotebookPen } from "lucide-react"
...
const navItems = [
  ...
  { href: "/app/payroll", icon: NotebookPen, label: "Payroll" },
